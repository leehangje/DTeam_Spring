...
public class MerchandiseDTO {
	...
	int md_price, md_deposit, md_fav_count, md_serial_number, md_rent_status, md_hits;
	public MerchandiseDTO(String md_name, String md_category, String md_rental_term, String md_detail_content,
			String md_photo_url, String member_id, String member_addr, String md_registration_date, int md_price,
			int md_deposit, int md_fav_count, int md_serial_number, int md_rent_status, int md_hits) {
		super();
